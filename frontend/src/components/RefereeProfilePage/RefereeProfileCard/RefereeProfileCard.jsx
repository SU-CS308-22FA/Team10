...
import "./RefereeProfileCard.css";
import { Fade, Flip } from "react-reveal";
import { style } from "glamor";
function RefereeProfileCard(props) {
  const refereeinfo = props.refereeinfo;
  ...
  return (
    <div className="refereeinfo-card">
          ...
          <div className="body-header" style={{ backgroundColor: "#3B3DB1" }}>
            <div className="body-header-title">
              ...
              <h3 className="card-subtitle" style={{ color: "#FFFFFF" }}>
                {refereeinfo.subtitle}
              </h3>
            </div>
            <div className="body-header-duration">
              <h3 className="duration" style={{ color: "#FFFFFF" }}>
                {refereeinfo.duration}
              </h3>
            </div>
          </div>
          <div classname="body-content">
            {refereeinfo.descriptions.map((sentence) => {
              return (
...
export default RefereeProfileCard;
