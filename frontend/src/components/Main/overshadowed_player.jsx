...
const Overshadowed_Player = () => {
    ...
    React.useEffect(() => {
      async function fetchData() {
          console.log("Ebrar");
          const playerURL =
            "http://localhost:8080/api/player/63624526fe649491f2e3057f";
    ...
    return <div className="row row-cols-4 row-cols-md-6 g-4">{myplayer.renderCard}</div>; //players.map yazıcaz
    }
