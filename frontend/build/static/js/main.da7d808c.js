                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              console.log("Ebrar"),
                              "https://weeklysoccer.onrender.com/api/player/637a8ed97757477ec0e7085b",
                              (e.next = 4),
                              Pn.get(
                                "https://weeklysoccer.onrender.com/api/player/637a8ed97757477ec0e7085b"
                              )
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              t.preventDefault(),
                              (e.prev = 1),
                              "https://weeklysoccer.onrender.com/api/auth",
                              (e.next = 5),
                              Pn.post(
                                "https://weeklysoccer.onrender.com/api/auth",
                                n
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (e.next = 2),
                              Pn.get(
                                "https://weeklysoccer.onrender.com/api/player/".concat(
                                  i
                                )
                              )
                                .then(function (e) {
